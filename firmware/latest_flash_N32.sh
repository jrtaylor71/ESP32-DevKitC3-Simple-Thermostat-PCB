...
LATEST_BUILD="$SCRIPT_DIR/N32/build_20260503-162217_v1.4.016"

echo "[FLASH] Using port: $PORT"
echo "[FLASH] Flashing ESP32-S3 N32 (32MB) - Latest Build (20260503-162217), version 1.4.016..."
...
esptool.py --chip esp32s3 --port "$PORT" --baud 460800 --before default_reset --after hard_reset write_flash -z \
    ...
    0x0 "$LATEST_BUILD/bootloader_v1.4.016_20260503-162217.bin" \
    0x8000 "$LATEST_BUILD/partitions_v1.4.016_20260503-162217.bin" \
    0x10000 "$LATEST_BUILD/firmware_v1.4.016_20260503-162217.bin"
