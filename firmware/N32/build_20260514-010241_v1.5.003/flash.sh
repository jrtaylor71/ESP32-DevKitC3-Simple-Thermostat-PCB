...
echo "[FLASH] Flashing ESP32-S3 esp32-s3-wroom-1-n32r16v (32MB), version 1.5.003, build 20260514-010241..."
...
esptool.py --chip esp32s3 --port "$PORT" --baud 460800 --before default_reset --after hard_reset write_flash -z \
    ...
    0x0 "$SCRIPT_DIR/bootloader_v1.5.003_20260514-010241.bin" \
    0x8000 "$SCRIPT_DIR/partitions_v1.5.003_20260514-010241.bin" \
    0x10000 "$SCRIPT_DIR/firmware_v1.5.003_20260514-010241.bin"
